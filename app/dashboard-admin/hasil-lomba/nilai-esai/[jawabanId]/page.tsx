/**
 * File                         : page.tsx (page for penilaian esai)
 * Created                      : 2025-07-19
 * Last Updated                 : 2025-07-19
 * Url                          : /dashboard-admin/hasil-lomba/nilai-esai/[jawabanId]
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-semibold text-gray-800">Penilaian - Soal Esai</h1>
      </div>
      <form onSubmit={handleSubmit}>
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200 max-w-4xl mx-auto space-y-6">
          ...
          <div>
            ...
            <div className="w-full p-3 bg-gray-100 border border-gray-200 rounded-md min-h-[200px] whitespace-pre-wrap">{dataSoal.jawaban}</div>
          </div>
          <div>
