...
import HasilUjianTable from '@/components/dashboard-admin/hasil-lomba/HasilLombaTable';
...
const mockHasilUjian = [
    ...
    { id: 3, noPendaftaran: '123123123', nama: 'Andi', cabor: 'OBN', mulai: '00:00', selesai: '00:00', jumlahSoal: 100, soalTerjawab: 100, soalBenar: 80, soalSalah: 20, nilai: 80, isChecked: false },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-4 rounded-lg shadow-sm">
        ...
        {/* Tabel Hasil Ujian */}
        <HasilUjianTable hasil={mockHasilUjian} />
      </div>
    </div>
  );
}