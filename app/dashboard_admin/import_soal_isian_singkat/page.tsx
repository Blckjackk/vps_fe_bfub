...
export default function ImportSoalIsianSingkatPage() {
    ...
    <div className="flex min-h-screen bg-[#FAFBFF]">
      ...
      <main className="flex-1 flex flex-col items-center py-10 px-2 md:px-8">
        <div className="w-full max-w-3xl mb-8">
          ...
          <h1 className="text-2xl font-bold mb-8">Import File Soal Isian Singkat</h1>
          <div className="bg-white rounded-xl shadow p-6 mb-6">
            ...
            <div className="text-sm text-gray-700 mb-2">Contoh: no,soal,bobot,jawaban</div>
