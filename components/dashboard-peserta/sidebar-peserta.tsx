...
export default function SidebarPeserta({
  ...
  return (
    <aside className="w-64 flex-shrink-0 bg-white shadow-md flex flex-col p-4 min-h-screen">
      {/* Logo dan Judul */}
      ...
      <div className="flex flex-col items-center gap-4 mb-6 mt-2">
        ...
        <div className="text-center">
          <div className="font-semibold text-gray-800">{namaPeserta}</div>
          <div className="text-xs text-gray-500">{asalSekolah}</div>
        </div>
      </div>
