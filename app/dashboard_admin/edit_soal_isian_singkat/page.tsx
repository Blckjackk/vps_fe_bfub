...
export default function EditSoalIsianSingkatPage() {
    ...
    <div className="flex min-h-screen bg-[#FAFBFF]">
      ...
      <main className="flex-1 flex flex-col items-center justify-center py-10 px-2 md:px-8">
        <div className="w-full max-w-5xl flex flex-col gap-y-2 mb-4">
          ...
          <h1 className="text-2xl font-bold ml-1 mb-2">Edit Soal Isian Singkat</h1>
        </div>
        <Card className="w-full max-w-5xl shadow-lg">
          <CardHeader>
            <CardTitle>Edit Soal Isian Singkat</CardTitle>
          </CardHeader>
          <CardContent>
