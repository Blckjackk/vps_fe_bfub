...
export default function TambahSoalIsianSingkatPage() {
  ...
  return (
    <div className="flex min-h-screen bg-[#FAFBFF]">
      ...
      <main className="flex-1 flex flex-col items-center justify-center py-10 px-2 md:px-8">
        ...
        <Link href="/dashboard_admin/edit_lomba" className="inline-block mb-6">
            <span className="text-2xl font-bold text-[#223A5F]"><FaArrowLeft /></span>
          </Link>
          <h1 className="text-2xl font-bold mb-8">Tambah Soal Isian Singkat</h1>
        </div>
